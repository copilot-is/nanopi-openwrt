...
wget https://github.com/coolsnowwolf/lede/67198ef5bed911ee87b696bfcb662b99e12e1fbb/master/target/linux/rockchip/patches-5.4/003-arm64-dts-rockchip-add-more-cpu-operating-points-for.patch
